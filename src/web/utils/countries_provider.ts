...
const _countries: DialCodeCountry[] = [
  {
    "num_code": "4",
    "alpha_2_code": "AF",
    "alpha_3_code": "AFG",
...
export const dial_code_countries = _countries.slice().sort((a, b) => {
  const codeA = parseInt(a.dial_code.replace(/\D/g, ''), 10);
  const codeB = parseInt(b.dial_code.replace(/\D/g, ''), 10);
